...
class DatabaseHandler:
    ...
    def update_listing(self, suburb, postcode, address, property_type, price, link, listing_tag, category, bathrooms, parking_spaces, square_metres, current_time, bedrooms):
        ...
        if result:
            ...
            # Insert new listing
            query = '''INSERT INTO listings (suburb, postcode, address, property_type, price, link, listing_tag, category, bathrooms, parking_spaces, square_metres, oldest_scraped_at, latest_scraped_at, bedrooms) 
                       VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)'''
            params = (suburb, postcode, address, property_type, price, link, listing_tag, category, bathrooms, parking_spaces, square_metres, current_time, current_time, bedrooms)
            self.execute_with_retry(query, params)
